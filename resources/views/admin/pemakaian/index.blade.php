            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="font-semibold text-xl text-gray-600 leading-tight">Daftar Pemakaian</h3>
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            @foreach ($pemakaians as $pemakaian)
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap px-4 py-4 text-sm">
                                        <p class="text-sm font-normal text-gray-600">
                                            {{ 'Rp ' . number_format($pemakaian->biaya_beban_pemakaia, 0, ',', '.') }}
                                        </p>
                                    </td>
                                    <td class="whitespace-nowrap px-4 py-4 text-sm">
                                        <p class="text-sm font-normal text-gray-600">
                                    ...
                                    <td class="whitespace-nowrap px-4 py-4 text-sm">
                                        <a
                                            href="{{ route('pemakaian.show', $pemakaian->id) }}"class="text-sm font-normal text-gray-600">
                                            Detail
                                        </a>
                                        <a
                                            href="{{ route('pemakaian.edit', $pemakaian->id) }}"class="text-sm font-normal text-gray-600">
                                            Edit
                                        </a>
